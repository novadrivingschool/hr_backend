...
export class Timesheet {
  ...
  @Column({ type: 'decimal', precision: 8, scale: 4, name: 'hours', default: 0 })
  hours: number;

  @Column({ type: 'decimal', precision: 8, scale: 4, name: 'paid_break', default: 0 })
  paid_break: number;

  @Column({ type: 'decimal', precision: 8, scale: 4, name: 'unpaid_break', default: 0 })
  unpaid_break: number;

  @Column({ type: 'decimal', precision: 8, scale: 4, name: 'day_wise_total_hours', default: 0 })
  day_wise_total_hours: number;

  @Column({ type: 'decimal', precision: 10, scale: 4, name: 'total_hours', default: 0 })
  total_hours: number;

  @Column({ type: 'decimal', precision: 8, scale: 4, name: 'total_paid_break', default: 0 })
  total_paid_break: number;

  @Column({ type: 'decimal', precision: 8, scale: 4, name: 'total_unpaid_break', default: 0 })
  total_unpaid_break: number;

  @Column({ type: 'decimal', precision: 10, scale: 4, name: 'total_day_wise_total_hours', default: 0 })
